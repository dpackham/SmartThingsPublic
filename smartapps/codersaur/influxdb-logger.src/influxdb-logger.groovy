...
private getGroupName(id) {
    ...
    if (id == null) {return 'Home'}
        else if (id == '2c0002f4-eef1-40dc-a9dd-c58c1089709c') {return 'Guest Room'}
        else if (id == '2f14bc9f-2417-497a-bbda-ed282695784b') {return 'Kitchen'}
        else if (id == '32a6f196-c3a7-4b2a-ab3f-5fe8c7680d04') {return 'Data Center'}
        else if (id == '5023e69f-66ef-429c-a4fd-291dba3d7ef7') {return 'Family Room'}
        else if (id == '5e7df001-4cf2-44e8-b91e-a6efea48ed36') {return 'Garage'}
        else if (id == '706873cb-1952-44c3-8403-1254288d1641') {return 'Living Room'}
        else if (id == '8cbe9e40-41a4-4226-a96a-8bd978e32dd3') {return 'Outside Back'}
        else if (id == '8d53b281-4326-4b07-8736-abd7cbce8b7b') {return 'Master Bedroom'}
        else if (id == '90346ed0-b0ee-4072-a59f-88eb1c2b9492') {return 'Downstairs Hall'}
        else if (id == 'a9ae28c5-9dd8-43bd-a8ea-3701f104e9c8') {return 'Outside Front'}
        else if (id == 'e289ceae-8e13-4327-a1e0-f84b7743d4ea') {return 'Upstairs Hall'}
        else if (id == 'ea19afff-c1e1-4ab7-8f2d-807ba5e074ba') {return 'Daves Office'}
    else {return 'Unknown'}    
}